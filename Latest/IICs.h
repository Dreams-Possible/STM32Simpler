...
////////////////////////////////////////////////////////////////
//
//#define IIC2_Software
#define IIC2_Hardware
//
////////////////////////////////////////////////////////////////
//结束选择使用软件IIC2还是硬件IIC2
...
//
//提供两个版本，前两个为直接传值，后四个为传指针
#if defined(IIC2_Software)||defined(IIC2_Hardware)
//发送字节
//设备地址，字节
...
#endif//defined(IIC2_Software)||defined(IIC2_Hardware)
...
#ifdef IIC2_Software
//IIC通信引脚名称默认为IIC2_SCL和IIC2_SDA
//IIC2_SCL引脚，开漏输出，初始高，默认上拉
//IIC2_SDA引脚，开漏输出，初始高，默认上拉
#define IIC2_SCL(x) HAL_GPIO_WritePin(IIC2_SCL_GPIO_Port,IIC2_SCL_Pin,(GPIO_PinState)(x))
#define IIC2_SDA(x) HAL_GPIO_WritePin(IIC2_SDA_GPIO_Port,IIC2_SDA_Pin,(GPIO_PinState)(x))
#define IIC2_SDA_In HAL_GPIO_ReadPin(IIC2_SDA_GPIO_Port,IIC2_SDA_Pin)//重定义SDA读取
