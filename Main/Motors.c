...
//定义电机速度
float volatile Motor1_Speed=0;
float volatile Motor2_Speed=0;
float volatile Motor3_Speed=0;
float volatile Motor4_Speed=0;
...
{
	Motor1_Driver(Motor1_Speed);
	Motor2_Driver(Motor2_Speed);
	Motor3_Driver(Motor3_Speed);
	Motor4_Driver(Motor4_Speed);
}
...
{
	Motor1_Printf(Motor1_Speed);
	Motor2_Printf(Motor2_Speed);
	Motor3_Printf(Motor3_Speed);
	Motor4_Printf(Motor4_Speed);
}
